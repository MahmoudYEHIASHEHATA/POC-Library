...
import com.cassbana.antifraud.data.source.local.UserDataSource
...
// Create the Interceptor
   return ChuckerInterceptor.Builder(Domain.application.baseContext)
...
fun provideCache(): Cache {
    return Cache(File(Domain.application.cacheDir, "Responses"), (10 * 1000 * 1000).toLong())
}
